...
export const quoteEmailTemplate = (
  ...
  const viewQuoteUrl = url || quote.viewQuoteUrl || '#';
  const quoteReference = quote.referenceNo ?? quote._id ?? 'N/A';
    ...
    <tr>
      <td align="center">
        ...
        <table class="email-container" width="540" cellpadding="0" cellspacing="0" style="width:540px;background:#ffffff;">
          ...
          <tr>
            <td align="center" style="padding:20px 20px 8px;">
              <a href="${viewQuoteUrl}" class="button" style="background:#00a878;color:#ffffff;text-decoration:none;font-size:12px;font-weight:bold;padding:10px 22px;display:inline-block;">
                View quote
              </a>
            </td>
          </tr>
                  ...
                  <td>
                    <table class="two-col" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td width="45%" align="right" class="mobile-center" style="padding:10px 0;">
                          <a href="${viewQuoteUrl}" class="button" style="border:2px solid #00a878;color:#00a878;text-decoration:none;font-size:12px;font-weight:bold;padding:9px 16px;display:inline-block;">
                            Submit photo survey
                          </a>
                        </td>
                      </tr>
          ...
          <tr>
            <td align="center" class="content" style="padding:0 26px 30px;">
              <a href="${viewQuoteUrl}" class="button" style="background:#00a878;color:#ffffff;text-decoration:none;font-size:12px;font-weight:bold;padding:11px 24px;display:inline-block;">
                Choose an installation date
              </a>
              <p style="margin:14px 0 0;color:#8b949e;font-size:11px;line-height:16px;">
                Next working day installation when you order by 3pm, subject to availability.
